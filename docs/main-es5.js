...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
                ...
                AuthGuard.prototype.canActivate = function () {
                    ...
                    return new Promise(function (resolve) {
                        _this.userService.getCurrentUser()
                            .then(function () {
                            _this.router.navigate(['/game']).catch(console.warn);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StepInterceptor = /** @class */ (function () {
                function StepInterceptor() {
                }
                StepInterceptor.prototype.intercept = function (req, next) {
                    var _this = this;
                    return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (event) { return _this.handleResponse(req, event); }));
                };
                StepInterceptor.prototype.handleResponse = function (req, event) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameComponent = /** @class */ (function () {
                function GameComponent(authService, route, location, game, http) {
                ...
                GameComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.data.subscribe(function (routeData) {
                        var user = routeData.data;
                        if (user) {
                            _this.http.get(user.displayName)
                                .toPromise()
                                .then(function (userJson) {
                                var _a = userJson.statistics, played = _a.played, won = _a.won, lost = _a.lost, drawn = _a.drawn, unfinished = _a.unfinished;
                                var correctStat = played - won - lost - drawn === unfinished;
                                _this.user = userJson;
                                _this.user.displayName = user.displayName;
                                if (!correctStat) {
                                    _this.updateStatistics('all');
                                }
                            });
                        }
                    });
                };
                Object.defineProperty(GameComponent.prototype, "gameModelForApi", {
                    get: function () {
                        return this.gameModel.map(function (mark) { return mark || '-'; }).join('');
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(GameComponent.prototype, "opponentMark", {
                    get: function () {
                ...
                Object.defineProperty(GameComponent.prototype, "gameModelObject", {
                    get: function () {
                        return {
                ...
                GameComponent.prototype.choosePlayer = function (chosenMark) {
                ...
                GameComponent.prototype.userStepHandler = function (cellIndex) {
                ...
                GameComponent.prototype.makeStep = function () {
                    var _this = this;
                    this.isLoading = true;
                    this.game.getNextStep({ player: this.opponentMark, game: this.gameModelForApi })
                        .then(function (recommendation) {
                        _this.gameModel[recommendation] = _this.opponentMark;
                        _this.checkState();
                        _this.isLoading = false;
                    });
                };
                GameComponent.prototype.toggleCurrentPlayer = function () {
                    this.currentPlayerMark = this.currentPlayerMark === this.X_MARK ? this.O_MARK : this.X_MARK;
                };
                GameComponent.prototype.checkState = function () {
                    var finished = this.gameModel.every(Boolean);
                    var filledLines = Object.entries(this.gameModelObject).filter(function (_a) {
                        var _b = __read(_a, 2), _ = _b[0], cells = _b[1];
                        return cells.every(Boolean);
                    });
                    var hasWinnerLine = filledLines.find(function (_a) {
                        var _b = __read(_a, 2), _ = _b[0], cells = _b[1];
                        return cells.every(function (mark, index, self) { return mark === self[0]; });
                    });
                    ...
                    if (finished && !this.winnerLine) {
                        ...
                        var userWon = this.userMark === this.currentPlayerMark;
                        this.isGameOver = true;
                        this.isResultShown = true;
                ...
                GameComponent.prototype.updateStatistics = function (key) {
                    var _this = this;
                    if (key === 'all') {
                        var _a = this.user.statistics, played = _a.played, won = _a.won, lost = _a.lost, drawn = _a.drawn;
                    ...
                    this.game.sendStatToServer(this.user)
                        .then(function (user) {
                        _this.user.statistics = user.statistics;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LandingComponent = /** @class */ (function () {
                function LandingComponent(authService, router, formBuilder) {
                    this.authService = authService;
                    this.router = router;
                ...
                LandingComponent.prototype.changeAuthMode = function () {
                    this.isLoginMode = !this.isLoginMode;
                };
                LandingComponent.prototype.createForm = function () {
                    this.authForm = this.formBuilder.group({ name: '', email: '', password: '' });
                };
                LandingComponent.prototype.tryAuth = function (value) {
                    var _this = this;
                    var action = this.isLoginMode ? 'doLogin' : 'doRegister';
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                function AuthService(afAuth, http, userService) {
                    this.afAuth = afAuth;
                    this.http = http;
                    this.userService = userService;
                }
                AuthService.prototype.doRegister = function (form) {
                    var _this = this;
                    return new Promise(function (resolve, reject) {
                        firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"]().createUserWithEmailAndPassword(form.email, form.password)
                            ...
                            _this.http.post("https://api.myjson.com/bins", postData)
                                .toPromise()
                                .then(function (bin) {
                                _this.userService.updateCurrentUser(bin.uri)
                                    .then(function () { return resolve(fbUserData); });
                            });
                ...
                AuthService.prototype.doLogin = function (value) {
                    return new Promise(function (resolve, reject) {
                        firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"]().signInWithEmailAndPassword(value.email, value.password)
                            .then(function (fbUserData) { return resolve(fbUserData); }, function (err) { return reject(err); });
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.updateCurrentUser = function (uri) {
                    return new Promise(function (resolve, reject) {
